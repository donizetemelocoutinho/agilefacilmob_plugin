...
class OwnerApi{
  ...
  Future<Map> Store(String fone, String descricao) async{
    ApiHelper api = ApiHelper();
    Map<String,dynamic> jo = Map();
    jo['id'] = await Helper.getId();
    jo['fone'] = fone;
    jo['descricao'] = descricao;
    return await api.post("owner/store", jo, params: {});
  }

  Future<Map> Validate(String code) async{
    ApiHelper api = ApiHelper();
    Map<String,dynamic> jo = Map();
    jo['id'] = await Helper.getId();
    jo['code'] = code;
    return await api.post("owner/validate", jo, params: {});
  }
}
